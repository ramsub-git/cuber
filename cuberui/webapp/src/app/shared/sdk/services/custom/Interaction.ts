...
/**
 * Api services for the `Interaction` model.
 */
@Injectable()
export class InteractionApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for Interaction registers.
   *
