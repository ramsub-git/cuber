...
/**
 * Api services for the `Argus` model.
 */
@Injectable()
export class ArgusApi extends BaseLoopBackApi {
  ...
  /**
   * Statistical information for argus registers.
   *
   ...
   * <em>
   * (The remote method definition does not provide any description.
   * This usually means the response is a `Argus` object.)
   * </em>
   */
